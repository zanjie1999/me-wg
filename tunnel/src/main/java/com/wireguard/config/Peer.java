...
/**
 * Represents the configuration for a 咩WG peer (a [Peer] block). Peers must have a public key,
...
public final class Peer {
    ...
    /**
     * Serializes the {@code Peer} for use with the 咩WG cross-platform userspace API. Note
